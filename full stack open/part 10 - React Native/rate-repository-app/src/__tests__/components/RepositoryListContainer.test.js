...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent(new RegExp(formatNumber(21856)));
      expect(firstRepositoryItem).toHaveTextContent(new RegExp(formatNumber(1619)));
      ...
      expect(secondRepositoryItem).toHaveTextContent(new RegExp(formatNumber(1760)));
      expect(secondRepositoryItem).toHaveTextContent(new RegExp(formatNumber(69)));
